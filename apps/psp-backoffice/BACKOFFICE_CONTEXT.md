...
│           ├── internal/crm/onboarding/...  # CRM expedientes (admin + proxy ops)
│           ├── settlements/...
│           ├── merchants/ops/...
