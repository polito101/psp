...
import { PaymentsV2OpsConfigurationController } from './payments-v2-ops-configuration.controller';
...
@Module({
  imports: [PrismaModule, LedgerModule, WebhooksModule, PaymentLinksModule, FeesModule, FxModule],
  controllers: [
    PaymentsV2Controller,
    PaymentsV2InternalController,
    PaymentsV2OpsConfigurationController,
  ],
  providers: [
    CorrelationContextService,
    CorrelationIdMiddleware,
    PaymentsV2Service,
    PaymentsV2OpsConfigurationService,
